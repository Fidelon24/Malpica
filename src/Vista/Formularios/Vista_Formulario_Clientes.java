 ...
 * @author Kevin
 */
public class Vista_Formulario_Clientes extends javax.swing.JDialog {

    /**
     * Creates new form Vista_ListadoProductos
     */
    public Vista_Formulario_Clientes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vista_Formulario_Clientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Vista_Formulario_Clientes dialog = new Vista_Formulario_Clientes(new javax.swing.JFrame(), true);
